var Scene = new (function() {
    ...
    this.Init = function() {
        ...
        Scene.Camera = new THREE.PerspectiveCamera(50, window.innerWidth/window.innerHeight, 0.1, 5000); // Initialize Camera
        Scene.Camera.position.x = 1020; // Behind Earth
        Scene.Camera.position.z = 45; // Horizontally further than moon
        Scene.Camera.rotation.y = 1.2; // Rotated back to see all 3
        Scene.Scene.add(Scene.Camera); // Add to scene
        addLight(0, 0, 0, 0); // Sunlight
        addLight(150, 0, 0, 180); // Makes sun visible
